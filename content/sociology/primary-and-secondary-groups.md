...
summary: Cooley's distinction between small, intimate, enduring groups that shape who we are (primary) and larger, more impersonal, goal-oriented groups that organize what we do (secondary).
